...
namespace AnToanBaoMat.Algorithms
{
    public class Playfair
    {
        public static string PlayfairEncryption(string sInput, string sKey)
        {
        ...
        public static string PlayfairDecryption(string sCipherText, string sKey)
        {
            sKey = sKey.ToLower();
            string sGrid = null;
            string sAlpha = "abcdefghiklmnopqrstuvwxyz";
